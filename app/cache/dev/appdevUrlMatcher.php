...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // index_recording
        if (0 === strpos($pathinfo, '/recording_private') && preg_match('#^/recording_private/(?P<id>\\d+)$#xs', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/recording') && preg_match('#^/recording/(?P<secretsalt>[^/]+?)$#xs', $pathinfo, $matches)) {
        ...
        // safe_title_recording
        if ($pathinfo === '/safe_title_recording') {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
                goto not_safe_title_recording;
            }
            return array (  '_controller' => 'Cmar\\MeetingBundle\\Controller\\UserController::safeTitleRecordingAction',  '_route' => 'safe_title_recording',);
        }
        not_safe_title_recording:
        ...
        // can_record
        if (0 === strpos($pathinfo, '/canrecord') && preg_match('#^/canrecord/(?P<canrecord>[^/]+?)/(?P<id>\\d+)$#xs', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Cmar\\MeetingBundle\\Controller\\UserController::changeToRecord',)), array('_route' => 'can_record'));
        }
        ...
        // locked_recording
        if (0 === strpos($pathinfo, '/locked_record') && preg_match('#^/locked_record/(?P<locked>[^/]+?)/(?P<secretsalt>[^/]+?)$#xs', $pathinfo, $matches)) {
        ...
        // admin_bars
        if ($pathinfo === '/admin_bars') {
            return array (  '_controller' => 'Cmar\\MeetingBundle\\Controller\\UserController::adminActionBars',  '_route' => 'admin_bars',);
        }
        ...
        // index_secretroom_cas
        if (0 === strpos($pathinfo, '/secretroomcas') && preg_match('#^/secretroomcas/(?P<salt>[^/]+?)$#xs', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  'secret' => true,  '_controller' => 'Cmar\\MeetingBundle\\Controller\\RoomController::roomAction',)), array('_route' => 'index_secretroom_cas'));
        }
        ...
        // logout_cas
        if ($pathinfo === '/logout') {
            return array (  '_controller' => 'Cmar\\MeetingBundle\\Controller\\SecurityController::logoutAction',  '_route' => 'logout_cas',);
        }
        ...
        // noaccess
        if ($pathinfo === '/noaccess') {
            return array (  '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\TemplateController::templateAction',  'template' => 'CmarMeetingBundle:Security:noaccess.html.twig',  '_route' => 'noaccess',);
        }
