...
";
    ...
    public function block_body($context, array $blocks = array())
    {
        // line 7
        echo "
<h2 style=\"border-bottom: 4px solid #b19653; color: #b19653; font-weight: bold; font-size: 18px; margin-bottom: 5px; padding: 0px 0px 5px 10px; margin-bottom: 25px;\">Recordings of ";
        // line 8
...
<div class=\"np\" style=\"margin: 20px\">
  ";
    ...
    <li style=\"";
            ...
            echo "font-weight: bolder; text-shadow: 0 1px 0 black; color: #FFFFFF\">
      <a ";
            // line 14
            if (($this->getAttribute($this->getContext($context, "recording"), "state") != 2)) {
                echo " target=\"_blank\" ";
            ...
            echo " href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("index_public_recording", array("secretsalt" => $this->getAttribute($this->getContext($context, "recording"), "secretsalt"))), "html", null, true);
            echo "\" style=\"";
            if (($this->getAttribute($this->getContext($context, "recording"), "state") == 0)) {
                echo "color: #0F8B1D;";
            } elseif (($this->getAttribute($this->getContext($context, "recording"), "state") == 1)) {
                echo " color: #E94646;";
            } else {
                echo " color: #7F8080;";
            }
            echo "text-shadow: none; text-decoration:none\"> ";
