...
\t\t  <button id=\"login-button\" class=\"button otherblue\" type=\"submit\" name=\"login\" value=\"Enter The Room\"><a href=\"";
        // line 81
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("index_secretroom_cas", array("salt" => $this->getAttribute($this->getContext($context, "meeting"), "secretsalt"))), "html", null, true);
        echo "\">Enter the room Using Single Sign-On</a></button>
\t\t</td>
\t      </tr>
\t    </tbody>
\t  </table>
