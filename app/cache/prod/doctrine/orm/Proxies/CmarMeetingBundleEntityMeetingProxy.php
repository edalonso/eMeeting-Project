...
class CmarMeetingBundleEntityMeetingProxy extends \Cmar\MeetingBundle\Entity\Meeting implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setCanRecord($record);
    }

    public function getCanRecord()
    {
        $this->__load();
        return parent::getCanRecord();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'state', 'salt', 'secretsalt', 'viewsalt', 'title', 'description', 'url', 'date', 'public', 'magic', 'canRecord', 'owner', 'group', 'users', 'recordings', 'nicknames', 'concurrent', 'created', 'updated');
    }
