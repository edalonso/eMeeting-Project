...
class Meeting
{
     ...
     * @var boolean $magic
     *
     * @ORM\Column(name="magic", type="boolean", nullable=true)
     */
    private $magic = false;
     ...
     * @var boolean $magic
     *
     * @ORM\Column(name="canRecord", type="boolean", nullable=true)
     */
    ...
    /**
     * @var ArrayCollection $nicknames
     *
     * @ORM\OneToMany(targetEntity="NickName", mappedBy="meeting", cascade={"all"}) 
     */
    private $nicknames;
    ...
    /**
     * Check if all users of the meeting can record.
     *
     * @return boolean
     */
    public function isCanRecord()
    {
        return $this->canRecord == true;
    }
     ...
     */
    public function setCanRecord($record)
    {
        $this->canRecord = $record;
    }
     ...
     */
    public function addNickname(NickName $nickname)
    {
     ...
     * @param NickName $nickname
     */
    public function removeNickname(NickName $nickname)
    {
        $this->nicknames->removeElement($nickname);
    }
     ...
     * @return boolean
     */
    public function containsNickname(NickName $nickname)
    {
